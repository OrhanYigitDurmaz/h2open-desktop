...
class Ui_AnaEkran(object):
    ...
    def retranslateUi(self, AnaEkran):
        ...
        self.pushButton_68.setText(QCoreApplication.translate("AnaEkran", u"Sale", None))
        self.pushButton_69.setText(QCoreApplication.translate("AnaEkran", u"Report to Car", None))
        self.pushButton_70.setText(QCoreApplication.translate("AnaEkran", u"Given", None))
        self.pushButton_71.setText(QCoreApplication.translate("AnaEkran", u"Edit", None))
        ...
        self.label_3.setText(QCoreApplication.translate("AnaEkran", u"Customer Details:", None))
        self.label_4.setText(QCoreApplication.translate("AnaEkran", u"Product:", None))
        self.label_5.setText(QCoreApplication.translate("AnaEkran", u"Payment Location :", None))
        self.label_6.setText(QCoreApplication.translate("AnaEkran", u" Order Status:", None))
        self.label_7.setText(QCoreApplication.translate("AnaEkran", u"Payment Method:", None))
        ...
        self.pushButton_14.setText(QCoreApplication.translate("AnaEkran", u"Tools", None))
        self.pushButton_15.setText(QCoreApplication.translate("AnaEkran", u"Help", None))
        self.pushButton_kapat_2.setText(QCoreApplication.translate("AnaEkran", u"Exit", None))
    # retranslateUi
